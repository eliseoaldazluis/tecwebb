...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/new_logo.png" alt="CompartiendoCodigo" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>sistemas de ventas</b><br>Teposcolula<br>Telefono:(+51)999999999<br>Email: cheo_eliseo2017@outlook.es
                </p>
            </div>
            <div id="fact">
                ...
                <table id="facarticulo">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th></th>
                            <th>SUBTOTAL</th>
                            <td>$ <?php echo e(round($v->total-($v->total*$v->impuesto),2)); ?></td>
                        </tr>
                        <tr>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th>Impuesto</th>
                            <td>$ <?php echo e(round($v->total*$v->impuesto,2)); ?></td>
                        </tr>
                        <tr>
                            <th></th>
                            <th></th>
